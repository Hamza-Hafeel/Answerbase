...
import { login as apiLogin, googleLogin as apiGoogleLogin, ApiError } from '@/lib/api';
  ...
  return (
    <div className="flex min-h-screen" style={{ background: '#0a0d3a' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center gradient-mesh">
        <div className="absolute left-1/3 top-1/3 h-80 w-80 rounded-full bg-[#5865f2]/20 blur-[120px]" />
        <div className="absolute right-1/4 bottom-1/4 h-60 w-60 rounded-full bg-[#ec48bd]/15 blur-[100px]" />
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <h2 className="mt-8 text-4xl font-extrabold text-white uppercase font-display tracking-tight">WELCOME BACK</h2>
          <p className="mt-4 text-white/50 leading-relaxed">
            Sign in to manage your AI chatbot, review conversations, and track analytics.
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <h1 className="text-3xl font-extrabold text-white uppercase font-display">SIGN IN</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                autoComplete="email"
                className="rounded-[12px] border-white/10 bg-[#1e2353] text-white placeholder:text-white/25 focus:border-[#5865f2] focus:ring-[#5865f2]/30 h-12"
              />
            </div>
            <div className="space-y-2">
          ...
          <p className="mt-6 text-center text-sm text-white/40">
            ...
            <Link href="/register" className="font-bold text-[#5865f2] hover:text-[#35ed7e] transition-colors">
              Create one
            </Link>
          </p>
        </div>
